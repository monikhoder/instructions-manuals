        ...
        <tbody>
            ...
            @else
                ...
                <td class="px-6 py-4">
                    ...
                    <form action="{{ route('admin.brand.remove', $brand) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-600 hover:underline ml-2" onclick="return confirm('Are you sure you want to delete this Brand?')">Delete</button>
                    </form>
                    </div>
                </td>
            </tr>
