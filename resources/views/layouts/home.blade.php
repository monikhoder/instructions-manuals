            ...
            <div class="flex flex-wrap items-center justify-between py-3 px-3">
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    @auth
                        <div class="flex items-center">
                            <div>
                                <a href="{{route('user.upload')}}" class="text-blue-900  focus:ring-gray-200 font-medium rounded-lg text-sm px-1 py-1 text-center ">
                                ...
                                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                                    ...
                                    <ul class="py-1" role="none">
                                        @if (Auth::user()->isAdmin())
                                            <li>
                                                <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Admin Dashboard</a>
                                            </li>
                                        @else
                                            <li>
                                                <a href="{{ route('user.dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">User Dashboard</a>
                                            </li>
                                        @endif
                                        <li>
                ...
                <div class="items-center justify-start md:flex-1 md:w-64  hidden w-full md:flex  md:order-1 md:mx-5" id="navbar-cta">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="{{url('/')}}" class="block py-2 px-3 md:p-0  rounded-sm {{ request()->is('/') ? 'text-blue-700' : 'hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 text-gray-900'}}" aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="{{url('about')}}" class="block py-2 px-3 md:p-0  rounded-sm {{ request()->is('about') ? 'text-blue-700' : 'hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 text-gray-900'}}">About</a>
                        </li>
                    </ul>
                </div>
            </div>
